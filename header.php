            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <button onclick="document.location.href='profil.php'" type="button" id="connexion" class="button button-primary" name="submit">Se connecter</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <input class="button button-primary" type="submit" name="submit" value="S'inscrire" />
                    </form>
                </div>
            </div>
        </div>
